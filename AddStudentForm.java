...
public class AddStudentForm extends JFrame {
	...
	public AddStudentForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=StudentDao.save(name, password, email, address, Branch, contact);
			if(i>0){
				...
				JOptionPane.showMessageDialog(AddStudentForm.this,"Sorry, unable to save!");
			}
			}
		});
